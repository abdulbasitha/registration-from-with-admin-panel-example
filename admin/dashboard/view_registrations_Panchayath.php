...
$p = strtolower($_POST['panchayath']);
 ...
 $_SESSION['panchayath']= strtolower($_POST['panchayath']);
   ...
   if(($d!=NULL)&&($c!=NULL)&&($p!=NULL))
          $queryq= $conn->query("SELECT * from registration_panchayath_msf where District='$d' and Constituency ='$c' and panchayath='$p'");
      elseif(($d!=NULL)&&($c!=NULL))
         $queryq= $conn->query("SELECT * from registration_panchayath_msf where District='$d' and Constituency ='$c'");
 ...
 $u =  $_SESSION['unit'];
   ...
   if(($d!=NULL)&&($c!=NULL)&&($p!=NULL))
      ...
      elseif(($d!=NULL)&&($c!=NULL))
         $queryq= $conn->query("SELECT * from registration_panchayath_msf where District='$d' and Constituency ='$c'");
     elseif($d!=NULL)
        $queryq= $conn->query("SELECT * from registration_panchayath_msf where District='$d'");
...
?>
    ...
    <title>View Panchayath Registration</title>
    <!-- google font -->
                         ...
                         unset($_SESSION['alert_msg']);
                           ...
                           <!--  alert_end -->
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="view_registrations_Panchayath.php">Registrations</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                            ...
                                            <tr class="odd gradeX">
                                               <td class="center">1</td>
                                                ...
                                                <td class="center">
                                                            ...
                                                            <a class="btn btn-tbl-delete btn-xs" href="../delete.php?id=<?php echo $data['id']; ?>&redirect=<?php echo $url; ?>&dl=panch" onclick="return confirm('Are you sure you want to delete this item?');">
                         ...
                         unset($_SESSION['alert_msg']);
                           ...
                           <!--  alert_end -->
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">View Panchayath Registration</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                ...
                                <li class="active">View Panchayath Registration</li>
                            </ol>
                        </div>
                    </div>
                    <form  method='post'>
                     <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="card-head">
                                    <header>View Panchayath Registration</header>
